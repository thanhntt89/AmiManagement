...
{
    public partial class UCMeasurementPointManagementTree : UserControlBase
    {
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            {
                this.btSearchMp_Click(null, null);
                return true;
            }
            return base.ProcessCmdKey(ref msg, keyData);
        }

        public UCMeasurementPointManagementTree()
        {
            InitializeComponent();
        ...
        void ucEvnTreeView_EvnTreeViewNodeSeletedEvent(NodeCustom nodeSelected)
        {
                ...
                for (int i = 0; i < this.measurementPointInfoDataTable.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ...
                        dtgMeasurementpoint.Rows.Add(
                            ...
                            item.IsConnectionStatusNull() ? string.Empty : item.ConnectionStatus == 1 ? Constant.DcuConnectedText : Constant.DcuDisconnectedText,
                        ...
                        // Trạng thái kết nối
                        if (!item.IsConnectionStatusNull() && item.ConnectionStatus == 0)
                            dtgMeasurementpoint.Rows[rowIndex].Cells[clConnectionStatus.Index].Style.ForeColor = Color.Red;
                        else
                            dtgMeasurementpoint.Rows[rowIndex].Cells[clConnectionStatus.Index].Style.ForeColor = Color.Green;
        ...
        private void Searching()
        {
            try
            {
                this.measurementPointInfoTableAdapter.FillByConditionsWithOrgId(this.measurementPointInfoDataTable,
                    mpCode,
                    dcuCode,
                    meterCode,
                    contactId,
